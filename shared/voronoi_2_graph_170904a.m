function [S] = voronoi_2_graph_170904a(N, voronoi_points_separated)
...
S = zeros(N,N);
for i = 1:size(voronoi_points_separated)
    S( voronoi_points_separated(i,1), voronoi_points_separated(i,2) ) = 1;
    S( voronoi_points_separated(i,2), voronoi_points_separated(i,1) ) = 1;
end
