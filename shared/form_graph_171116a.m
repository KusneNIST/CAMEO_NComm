function [S] = form_graph_171116a(C, XY, experiment)
...
[~, ~, ~, v4] = find_lines_separating_points_170819a(xy);
S = voronoi_2_graph_170904a( N , v4);
D = dist(xy');
S = prune_graph_141021a(S,D,experiment.graph_distance_multiplier,experiment.graph_NN);
S = sparse(S);
