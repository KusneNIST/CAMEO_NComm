To run the CAMEO simulation code, run the script: FeGaPd_ALBO_200801a.m
All data can be found in the folder "data".
Function dependencies can be found in the folders "Graph Cut mex2.0" and "shared".
...
% Kusne, A. Gilad, et al. "On-the-fly Closed-loop Autonomous Materials
